# mysql 대체 mysqlsh 접속 가이드

- 이 시스템에는 `mysql` 명령어가 없습니다 대신 `mysqlsh`를 사용하세요
  ("/c/Program Files/MySQL/MySQL Shell 8.0/bin/mysqlsh.exe")

- 이 프로젝트에서 사용하는 mariadb는 url은 "jdbc:mariadb://172.16.100.200:13306/lawcollector", 접속정보는 root / root이다.
...
C:\WINDOWS\my.ini C:\WINDOWS\my.cnf C:\my.ini C:\my.cnf C:\Program Files\MySQL\MySQL Shell 8.0\my.ini C:\Program Files\MySQL\MySQL Shell 8.0\my.cnf
